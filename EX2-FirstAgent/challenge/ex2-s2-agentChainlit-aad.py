...
async def start():
    ...
    try:
        ...
        await cl.Message(
            content="🤖 Hello! I'm your IBM Travel Companion Agent powered by Azure AI Foundry. "
                    "I'm here to help you with any questions you may have with your trip "
        ...
        agent = project.agents.create_agent(
            ...
            instructions=""" You are an expert travel agent advisor.
            You must help users plan trips by providing recommendations for the following:
            - Attractions and activities
            - Transportation options
            - Hidden gems and local favourites

            Be enthusiastic and helpful. Use the user's destination to tailor all your recommendations.
            """,
